...
if (message.content.startsWith(prefix + 'help')) {
	...
	『 كلمات عن صاحب بوت ومبرمجه』
	 ▓ مبرمج البوت | ▓| Hodka
	  ▓ مشارك في البوت | ▓| NeMaR
	   ▓ فكرة البوت |  ▓ | انو يقدم مساعده لاصحاب سرفر وشكرا والفكرة انو رجعنا اكواد وذكرات Flash Bot
     ===========================================================
    ...
    ❖ -dc => Delete All Rooms |  مسح كل الرومات     ▓ هذه الخاصية لبوت البروميوم الذي سنيزل بعد البوت باسبوع |  ▓ |
    ...
    ❖ -vonline => Create Channel Voice Online | يسوي رووم فويس اونلاين  ▓ هذه الخاصية لبوت البروميوم الذي سنيزل بعد البوت باسبوع |  ▓ |
     ===========================================================
	...
	▓ هذه الالعاب قديمة ومعروفة سيتم اضافة لعبه شطرنج او لعبه مماثلة لببجي |\ او فورت نايت |  ▓ |
	...
	▓ هذه الخاصية لبوت البروميوم الذي سنيزل بعد البوت باسبوع |  ▓ |
...
client.login(NTk4MTY0MDM4ODc0MDM4Mjc1.XSSqMA.1gjAvjAgHM34NniszQ7hpmviIh8);
